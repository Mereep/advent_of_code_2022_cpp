...
struct Operation {
    ...
    static Operation fromLine(string operation) {
        ...
        if (operation.starts_with("Operation: new = old +")) {
            ...
            // hint: do NOT change the order of the if statements
            // as the next one would "eat" this one
            return Operation {
                    .op = OperationType::SQUARE,
                    .value = 0,
            };
